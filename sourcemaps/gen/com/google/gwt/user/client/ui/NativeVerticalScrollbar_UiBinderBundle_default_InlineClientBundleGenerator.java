  ...
  private void nativeVerticalScrollbarUiInitializer() {
    nativeVerticalScrollbarUi = new com.google.gwt.user.client.ui.NativeVerticalScrollbar.UiStyle() {
      ...
      public String getText() {
        return (".GD0PFO4BOI{position:" + ("relative")  + ";overflow:" + ("hidden")  + ";direction:" + ("ltr")  + ";}.GD0PFO4BNI{position:" + ("absolute")  + ";top:" + ("0")  + ";right:" + ("0")  + ";height:" + ("100%")  + ";width:" + ("100px")  + ";overflow-y:" + ("scroll")  + ";overflow-x:" + ("hidden")  + ";}");
      }
