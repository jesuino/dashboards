// .ui.xml template last modified: 1657649672188
...
public class WorkbenchToolBarView_WorkbenchToolBarViewBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Panel, org.uberfire.client.views.pfly.toolbar.WorkbenchToolBarView>, org.uberfire.client.views.pfly.toolbar.WorkbenchToolBarView.WorkbenchToolBarViewBinder {
  ...
  class Widgets {
     ...
     */
    private com.google.gwt.user.client.ui.FlowPanel get_mainContainer() {
      return build_mainContainer();
    }
    private com.google.gwt.user.client.ui.FlowPanel build_mainContainer() {
      // Creation section.
      final com.google.gwt.user.client.ui.FlowPanel mainContainer = (com.google.gwt.user.client.ui.FlowPanel) GWT.create(com.google.gwt.user.client.ui.FlowPanel.class);
      // Setup section.
      mainContainer.add(get_container());
      mainContainer.add(get_simpleMargin());

      this.owner.mainContainer = mainContainer;
