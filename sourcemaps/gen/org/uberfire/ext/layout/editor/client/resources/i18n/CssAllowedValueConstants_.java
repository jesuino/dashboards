...
public class CssAllowedValueConstants_ implements org.uberfire.ext.layout.editor.client.resources.i18n.CssAllowedValueConstants {
  ...
  public java.lang.String FLOAT__NONE() {
    return "None";
  }
  
  public java.lang.String FLOAT__LEFT() {
    return "Left";
  }
  
  public java.lang.String FLOAT__RIGHT() {
    return "Right";
  }
  
  public java.lang.String FLOAT__INITIAL() {
    return "Initial";
  }
  
  public java.lang.String FLOAT__INHERIT() {
    return "Inherit";
  }
  ...
  public java.lang.String getString(java.lang.String arg0) {
    ...
    if (arg0.equals("FLOAT__NONE")) {
      String answer = FLOAT__NONE();
      cache.put("FLOAT__NONE",answer);
      return answer;
    }
    if (arg0.equals("FLOAT__LEFT")) {
      String answer = FLOAT__LEFT();
      cache.put("FLOAT__LEFT",answer);
      return answer;
    }
    if (arg0.equals("FLOAT__RIGHT")) {
      String answer = FLOAT__RIGHT();
      cache.put("FLOAT__RIGHT",answer);
      return answer;
    }
    if (arg0.equals("FLOAT__INITIAL")) {
      String answer = FLOAT__INITIAL();
      cache.put("FLOAT__INITIAL",answer);
      return answer;
    }
    if (arg0.equals("FLOAT__INHERIT")) {
      String answer = FLOAT__INHERIT();
      cache.put("FLOAT__INHERIT",answer);
      return answer;
    }
    throw new java.util.MissingResourceException("Cannot find constant '" +arg0 + "'; expecting a method name", "org.uberfire.ext.layout.editor.client.resources.i18n.CssAllowedValueConstants", arg0);
  }
