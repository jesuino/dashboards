...
public class FileUpload_FileUploadBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, org.uberfire.ext.widgets.common.client.common.FileUpload>, org.uberfire.ext.widgets.common.client.common.FileUpload.FileUploadBinder {
  ...
  class Widgets {
    ...
    private org.gwtbootstrap3.client.ui.InputGroup build_f_InputGroup1() {
      ...
      f_InputGroup1.add(get_inputFileName());
    ...
    /**
     * Getter for inputFileName called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    private org.gwtbootstrap3.client.ui.Input get_inputFileName() {
      return build_inputFileName();
    }
    private org.gwtbootstrap3.client.ui.Input build_inputFileName() {
      // Creation section.
      final org.gwtbootstrap3.client.ui.Input inputFileName = new org.gwtbootstrap3.client.ui.Input(org.gwtbootstrap3.client.ui.constants.InputType.TEXT);
      // Setup section.
      inputFileName.setVisible(false);

      this.owner.inputFileName = inputFileName;
