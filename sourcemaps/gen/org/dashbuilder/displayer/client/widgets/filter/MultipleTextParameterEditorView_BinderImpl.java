...
public class MultipleTextParameterEditorView_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, org.dashbuilder.displayer.client.widgets.filter.MultipleTextParameterEditorView>, org.dashbuilder.displayer.client.widgets.filter.MultipleTextParameterEditorView.Binder {


  public com.google.gwt.user.client.ui.Widget createAndBindUi(final org.dashbuilder.displayer.client.widgets.filter.MultipleTextParameterEditorView owner) {
   ...
   */
  class Widgets {
    private final org.dashbuilder.displayer.client.widgets.filter.MultipleTextParameterEditorView owner;


    public Widgets(final org.dashbuilder.displayer.client.widgets.filter.MultipleTextParameterEditorView owner) {
      this.owner = owner;
    }
     ...
     */
    private org.dashbuilder.displayer.client.widgets.filter.MultipleTextParameterEditorView_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private org.dashbuilder.displayer.client.widgets.filter.MultipleTextParameterEditorView_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final org.dashbuilder.displayer.client.widgets.filter.MultipleTextParameterEditorView_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (org.dashbuilder.displayer.client.widgets.filter.MultipleTextParameterEditorView_BinderImpl_GenBundle) GWT.create(org.dashbuilder.displayer.client.widgets.filter.MultipleTextParameterEditorView_BinderImpl_GenBundle.class);
      // Setup section.
