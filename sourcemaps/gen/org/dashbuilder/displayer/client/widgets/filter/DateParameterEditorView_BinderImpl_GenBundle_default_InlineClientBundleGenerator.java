  ...
  private void styleInitializer() {
    style = new org.dashbuilder.displayer.client.widgets.filter.DateParameterEditorView_BinderImpl_GenCss_style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GD0PFO4BHR{float:" + ("right")  + ";width:" + ("275px")  + ";}.GD0PFO4BGR{margin-right:" + ("-1px")  + ";}")) : ((".GD0PFO4BHR{float:" + ("left")  + ";width:" + ("275px")  + ";}.GD0PFO4BGR{margin-left:" + ("-1px")  + ";}"));
      }
