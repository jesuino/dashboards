...
public class DropDownEditorView_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, org.dashbuilder.common.client.editor.list.DropDownEditorView>, org.dashbuilder.common.client.editor.list.DropDownEditorView.Binder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final org.dashbuilder.common.client.editor.list.DropDownEditorView owner) {
   ...
   */
  class Widgets {
    private final org.dashbuilder.common.client.editor.list.DropDownEditorView owner;


    public Widgets(final org.dashbuilder.common.client.editor.list.DropDownEditorView owner) {
      this.owner = owner;
     ...
     */
    private org.dashbuilder.common.client.editor.list.DropDownEditorView_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private org.dashbuilder.common.client.editor.list.DropDownEditorView_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final org.dashbuilder.common.client.editor.list.DropDownEditorView_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (org.dashbuilder.common.client.editor.list.DropDownEditorView_BinderImpl_GenBundle) GWT.create(org.dashbuilder.common.client.editor.list.DropDownEditorView_BinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private org.dashbuilder.common.client.editor.list.DropDownEditorView_BinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private org.dashbuilder.common.client.editor.list.DropDownEditorView_BinderImpl_GenCss_style build_style() {
      // Creation section.
      final org.dashbuilder.common.client.editor.list.DropDownEditorView_BinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
