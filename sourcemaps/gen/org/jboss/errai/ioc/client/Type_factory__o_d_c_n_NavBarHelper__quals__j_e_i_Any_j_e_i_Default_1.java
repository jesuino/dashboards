...
public class Type_factory__o_d_c_n_NavBarHelper__quals__j_e_i_Any_j_e_i_Default_1 extends Factory<NavBarHelper> { private class Type_factory__o_d_c_n_NavBarHelper__quals__j_e_i_Any_j_e_i_Default_1ProxyImpl extends NavBarHelper implements Proxy<NavBarHelper> {
    private final ProxyHelper<NavBarHelper> proxyHelper = new ProxyHelperImpl<NavBarHelper>("Type_factory__o_d_c_n_NavBarHelper__quals__j_e_i_Any_j_e_i_Default_1");
  ...
  public Type_factory__o_d_c_n_NavBarHelper__quals__j_e_i_Any_j_e_i_Default_1() {
    super(new FactoryHandleImpl(NavBarHelper.class, "Type_factory__o_d_c_n_NavBarHelper__quals__j_e_i_Any_j_e_i_Default_1", ApplicationScoped.class, false, null, true));
  ...
  public Proxy createProxy(final Context context) {
    final Proxy<NavBarHelper> proxyImpl = new Type_factory__o_d_c_n_NavBarHelper__quals__j_e_i_Any_j_e_i_Default_1ProxyImpl();
