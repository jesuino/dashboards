...
public class Type_factory__o_u_b_v_i_ObservablePathImpl__quals__j_e_i_Any_j_e_i_Default extends Factory<ObservablePathImpl> { public Type_factory__o_u_b_v_i_ObservablePathImpl__quals__j_e_i_Any_j_e_i_Default() {
    ...
    handle.setAssignableTypes(new Class[] { ObservablePathImpl.class, Object.class, ObservablePath.class, Path.class, Comparable.class, Disposable.class });
  }
  ...
  public ObservablePathImpl createInstance(final ContextManager contextManager) {
    ...
    thisInstance.setReference(instance, "onResourceRenamedSubscription", CDI.subscribe("org.uberfire.workbench.events.ResourceRenamedEvent", new AbstractCDIEventCallback<ResourceRenamedEvent>() {
    ...
    thisInstance.setReference(instance, "onResourceRenamedSubscriptionForResourceRenamedEvent", ErraiBus.get().subscribe("cdi.event:org.uberfire.workbench.events.ResourceRenamedEvent", CDI.ROUTING_CALLBACK));
    thisInstance.setReference(instance, "onResourceDeletedSubscription", CDI.subscribe("org.uberfire.workbench.events.ResourceDeletedEvent", new AbstractCDIEventCallback<ResourceDeletedEvent>() {
    ...
    thisInstance.setReference(instance, "onResourceDeletedSubscriptionForResourceDeletedEvent", ErraiBus.get().subscribe("cdi.event:org.uberfire.workbench.events.ResourceDeletedEvent", CDI.ROUTING_CALLBACK));
    thisInstance.setReference(instance, "onResourceUpdatedSubscription", CDI.subscribe("org.uberfire.workbench.events.ResourceUpdatedEvent", new AbstractCDIEventCallback<ResourceUpdatedEvent>() {
    ...
    thisInstance.setReference(instance, "onResourceUpdatedSubscriptionForResourceUpdatedEvent", ErraiBus.get().subscribe("cdi.event:org.uberfire.workbench.events.ResourceUpdatedEvent", CDI.ROUTING_CALLBACK));
    thisInstance.setReference(instance, "onResourceCopiedSubscription", CDI.subscribe("org.uberfire.workbench.events.ResourceCopiedEvent", new AbstractCDIEventCallback<ResourceCopiedEvent>() {
    ...
    thisInstance.setReference(instance, "onResourceCopiedSubscriptionForResourceCopiedEvent", ErraiBus.get().subscribe("cdi.event:org.uberfire.workbench.events.ResourceCopiedEvent", CDI.ROUTING_CALLBACK));
    thisInstance.setReference(instance, "onResourceBatchEventSubscription", CDI.subscribe("org.uberfire.workbench.events.ResourceBatchChangesEvent", new AbstractCDIEventCallback<ResourceBatchChangesEvent>() {
    ...
    thisInstance.setReference(instance, "onResourceBatchEventSubscriptionForResourceBatchChangesEvent", ErraiBus.get().subscribe("cdi.event:org.uberfire.workbench.events.ResourceBatchChangesEvent", CDI.ROUTING_CALLBACK));
  ...
  public void destroyInstanceHelper(final ObservablePathImpl instance, final ContextManager contextManager) {
    ...
    ((Subscription) thisInstance.getReferenceAs(instance, "onResourceRenamedSubscriptionForResourceRenamedEvent", Subscription.class)).remove();
    ((Subscription) thisInstance.getReferenceAs(instance, "onResourceDeletedSubscription", Subscription.class)).remove();
    ((Subscription) thisInstance.getReferenceAs(instance, "onResourceDeletedSubscriptionForResourceDeletedEvent", Subscription.class)).remove();
    ((Subscription) thisInstance.getReferenceAs(instance, "onResourceUpdatedSubscription", Subscription.class)).remove();
    ((Subscription) thisInstance.getReferenceAs(instance, "onResourceUpdatedSubscriptionForResourceUpdatedEvent", Subscription.class)).remove();
    ((Subscription) thisInstance.getReferenceAs(instance, "onResourceCopiedSubscription", Subscription.class)).remove();
    ((Subscription) thisInstance.getReferenceAs(instance, "onResourceCopiedSubscriptionForResourceCopiedEvent", Subscription.class)).remove();
    ((Subscription) thisInstance.getReferenceAs(instance, "onResourceBatchEventSubscription", Subscription.class)).remove();
    ((Subscription) thisInstance.getReferenceAs(instance, "onResourceBatchEventSubscriptionForResourceBatchChangesEvent", Subscription.class)).remove();
  }
