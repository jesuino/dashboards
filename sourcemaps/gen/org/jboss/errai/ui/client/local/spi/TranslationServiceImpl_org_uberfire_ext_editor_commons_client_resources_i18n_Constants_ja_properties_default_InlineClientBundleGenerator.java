...
public class TranslationServiceImpl_org_uberfire_ext_editor_commons_client_resources_i18n_Constants_ja_properties_default_InlineClientBundleGenerator implements org.jboss.errai.ui.client.local.spi.TranslationServiceImpl.org_uberfire_ext_editor_commons_client_resources_i18n_Constants_ja_properties {
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      case 'getContents': return this.@org.jboss.errai.ui.client.local.spi.TranslationServiceImpl.org_uberfire_ext_editor_commons_client_resources_i18n_Constants_ja_properties::getContents()();
    }
    return null;
  }-*/;
}
