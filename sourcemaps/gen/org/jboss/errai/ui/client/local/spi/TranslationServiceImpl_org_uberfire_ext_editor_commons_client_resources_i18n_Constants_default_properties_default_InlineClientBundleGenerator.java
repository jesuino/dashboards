...
public class TranslationServiceImpl_org_uberfire_ext_editor_commons_client_resources_i18n_Constants_default_properties_default_InlineClientBundleGenerator implements org.jboss.errai.ui.client.local.spi.TranslationServiceImpl.org_uberfire_ext_editor_commons_client_resources_i18n_Constants_default_properties {
  private static TranslationServiceImpl_org_uberfire_ext_editor_commons_client_resources_i18n_Constants_default_properties_default_InlineClientBundleGenerator _instance0 = new TranslationServiceImpl_org_uberfire_ext_editor_commons_client_resources_i18n_Constants_default_properties_default_InlineClientBundleGenerator();
  private void getContentsInitializer() {
    getContents = new com.google.gwt.resources.client.TextResource() {
      // jar:file:/home/wsiqueir/.m2/repository/org/uberfire/uberfire-commons-editor-client/0.0.0/uberfire-commons-editor-client-0.0.0.jar!/org/uberfire/ext/editor/commons/client/resources/i18n/Constants_default.properties
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      case 'getContents': return this.@org.jboss.errai.ui.client.local.spi.TranslationServiceImpl.org_uberfire_ext_editor_commons_client_resources_i18n_Constants_default_properties::getContents()();
    }
    return null;
  }-*/;
}
