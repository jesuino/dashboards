...
public class Marshaller_o_d_d_i_TableDisplayerSettingsBuilderImpl_Impl implements GeneratedMarshaller<TableDisplayerSettingsBuilderImpl> {
  ...
  public String marshall(TableDisplayerSettingsBuilderImpl a0, MarshallingSession a1) {
    ...
    return prefix + ((((((((("" + ",\"") + "displayerSettings") + "\":") + org_dashbuilder_displayer_DisplayerSettings.marshall(AbstractDisplayerSettingsBuilder_DisplayerSettings_displayerSettings(a0), a1)) + ",\"") + "dataSetLookup") + "\":") + java_lang_Object.marshall(AbstractDataSetLookupBuilder_DataSetLookup_dataSetLookup(a0), a1)) + "}");
  }
