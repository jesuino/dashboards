...
public class Marshaller_o_u_e_p_e_m_v_ColorValidator_Impl implements GeneratedMarshaller<ColorValidator> {
  ...
  public String marshall(ColorValidator a0, MarshallingSession a1) {
    ...
    final String prefix = ((((((((("" + "{\"") + "^EncodedType") + "\":\"") + "org.uberfire.ext.properties.editor.model.validators.ColorValidator") + "\"") + ",\"") + "^ObjectID") + "\":\"") + a1.getObject(a0)) + "\"";
    if (ref) {
      return prefix + "}";
    }
