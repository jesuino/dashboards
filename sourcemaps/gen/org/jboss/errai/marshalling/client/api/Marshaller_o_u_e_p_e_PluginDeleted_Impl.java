...
public class Marshaller_o_u_e_p_e_PluginDeleted_Impl implements GeneratedMarshaller<PluginDeleted> {
  ...
  public PluginDeleted demarshall(EJValue a0, MarshallingSession a1) {
    ...
    PluginDeleted entity = new PluginDeleted(c0, c1);
  ...
  public String marshall(PluginDeleted a0, MarshallingSession a1) {
    ...
    final String prefix = ((((((((("" + "{\"") + "^EncodedType") + "\":\"") + "org.uberfire.ext.plugin.event.PluginDeleted") + "\"") + ",\"") + "^ObjectID") + "\":\"") + a1.getObject(a0)) + "\"";
    if (ref) {
      return prefix + "}";
    }
