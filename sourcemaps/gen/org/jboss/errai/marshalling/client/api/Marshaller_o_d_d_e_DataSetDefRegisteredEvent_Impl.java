...
public class Marshaller_o_d_d_e_DataSetDefRegisteredEvent_Impl implements GeneratedMarshaller<DataSetDefRegisteredEvent> {
  ...
  public String marshall(DataSetDefRegisteredEvent a0, MarshallingSession a1) {
    ...
    final String prefix = ((((((((("" + "{\"") + "^EncodedType") + "\":\"") + "org.dashbuilder.dataset.events.DataSetDefRegisteredEvent") + "\"") + ",\"") + "^ObjectID") + "\":\"") + a1.getObject(a0)) + "\"";
    if (ref) {
      return prefix + "}";
    }
