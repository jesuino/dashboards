...
public class Marshaller_o_u_e_p_e_PluginAlreadyExists_Impl implements GeneratedMarshaller<PluginAlreadyExists> {
  ...
  public PluginAlreadyExists demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(PluginAlreadyExists.class, objId);
    }
    PluginAlreadyExists entity = new PluginAlreadyExists();
  ...
  public String marshall(PluginAlreadyExists a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final String prefix = ((((((((("" + "{\"") + "^EncodedType") + "\":\"") + "org.uberfire.ext.plugin.exception.PluginAlreadyExists") + "\"") + ",\"") + "^ObjectID") + "\":\"") + a1.getObject(a0)) + "\"";
    if (ref) {
      return prefix + "}";
    }
    return prefix + ((((((((((((((((("" + ",\"") + "detailMessage") + "\":") + java_lang_String.marshall(Throwable_String_detailMessage(a0), a1)) + ",\"") + "stackTrace") + "\":") + arrayOf_java_lang_StackTraceElement_D1.marshall(a0.getStackTrace(), a1)) + ",\"") + "message") + "\":") + java_lang_String.marshall(a0.getMessage(), a1)) + ",\"") + "cause") + "\":") + java_lang_Throwable.marshall(a0.getCause(), a1)) + "}");
  }
