...
public class Marshaller_o_u_e_s_s_p_GridColumnPreference_Impl implements GeneratedMarshaller<GridColumnPreference> {
  ...
  public String marshall(GridColumnPreference a0, MarshallingSession a1) {
    ...
    final String prefix = ((((((((("" + "{\"") + "^EncodedType") + "\":\"") + "org.uberfire.ext.services.shared.preferences.GridColumnPreference") + "\"") + ",\"") + "^ObjectID") + "\":\"") + a1.getObject(a0)) + "\"";
    if (ref) {
      return prefix + "}";
    }
    return prefix + ((((((((((((("" + ",\"") + "name") + "\":") + java_lang_String.marshall(a0.getName(), a1)) + ",\"") + "position") + "\":") + java_lang_Integer.marshall(a0.getPosition(), a1)) + ",\"") + "width") + "\":") + java_lang_String.marshall(a0.getWidth(), a1)) + "}");
  }
