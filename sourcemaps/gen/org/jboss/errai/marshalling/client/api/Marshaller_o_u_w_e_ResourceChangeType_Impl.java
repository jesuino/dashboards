...
public class Marshaller_o_u_w_e_ResourceChangeType_Impl implements GeneratedMarshaller<ResourceChangeType> {
  ...
  public String marshall(ResourceChangeType a0, MarshallingSession a1) {
    ...
    return a0 != null ? ((((((("{\"" + "^EncodedType") + "\":\"") + "org.uberfire.workbench.events.ResourceChangeType") + "\",\"") + "^EnumStringValue") + "\":\"") + a0.name()) + "\"}" : "null";
  }
