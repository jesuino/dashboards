...
public class Marshaller_o_u_m_i_PathPlaceRequest_Impl implements GeneratedMarshaller<PathPlaceRequest> {
  ...
  public String marshall(PathPlaceRequest a0, MarshallingSession a1) {
    ...
    final String prefix = ((((((((("" + "{\"") + "^EncodedType") + "\":\"") + "org.uberfire.mvp.impl.PathPlaceRequest") + "\"") + ",\"") + "^ObjectID") + "\":\"") + a1.getObject(a0)) + "\"";
    if (ref) {
      return prefix + "}";
    }
