...
public class Marshaller_o_u_e_p_e_PluginAdded_Impl implements GeneratedMarshaller<PluginAdded> {
  ...
  public String marshall(PluginAdded a0, MarshallingSession a1) {
    ...
    final String prefix = ((((((((("" + "{\"") + "^EncodedType") + "\":\"") + "org.uberfire.ext.plugin.event.PluginAdded") + "\"") + ",\"") + "^ObjectID") + "\":\"") + a1.getObject(a0)) + "\"";
    if (ref) {
      return prefix + "}";
    }
