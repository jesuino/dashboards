...
public class Marshaller_o_u_p_PageRequest_Impl implements GeneratedMarshaller<PageRequest> {
  ...
  public String marshall(PageRequest a0, MarshallingSession a1) {
    ...
    final String prefix = ((((((((("" + "{\"") + "^EncodedType") + "\":\"") + "org.uberfire.paging.PageRequest") + "\"") + ",\"") + "^ObjectID") + "\":\"") + a1.getObject(a0)) + "\"";
    if (ref) {
      return prefix + "}";
    }
    return prefix + ((((((((("" + ",\"") + "startRowIndex") + "\":") + java_lang_Integer.marshall(a0.getStartRowIndex(), a1)) + ",\"") + "pageSize") + "\":") + java_lang_Integer.marshall(a0.getPageSize(), a1)) + "}");
  }
