...
public class Marshaller_o_u_w_e_ResourceDeleted_Impl implements GeneratedMarshaller<ResourceDeleted> {
  ...
  public String marshall(ResourceDeleted a0, MarshallingSession a1) {
    ...
    final String prefix = ((((((((("" + "{\"") + "^EncodedType") + "\":\"") + "org.uberfire.workbench.events.ResourceDeleted") + "\"") + ",\"") + "^ObjectID") + "\":\"") + a1.getObject(a0)) + "\"";
    if (ref) {
      return prefix + "}";
    }
