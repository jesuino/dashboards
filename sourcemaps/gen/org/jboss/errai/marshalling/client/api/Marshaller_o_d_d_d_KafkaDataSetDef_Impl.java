...
public class Marshaller_o_d_d_d_KafkaDataSetDef_Impl implements GeneratedMarshaller<KafkaDataSetDef> {
  private KafkaDataSetDef[] EMPTY_ARRAY = new KafkaDataSetDef[0];
  private Marshaller<String> java_lang_String = Marshalling.getMarshaller(String.class);
  private Marshaller<MetricsTarget> org_dashbuilder_dataset_def_KafkaDataSetDef_erraiD_MetricsTarget = null;
  ...
  public KafkaDataSetDef demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(KafkaDataSetDef.class, objId);
    }
    KafkaDataSetDef entity = new KafkaDataSetDef();
    ...
    for (String key : keys) {
      ...
      switch (key) {
        case "host": entity.setHost(java_lang_String.demarshall(objVal, a1));
        break;
        case "port": entity.setPort(java_lang_String.demarshall(objVal, a1));
        break;
        case "target": entity.setTarget(objVal.isObject() != null ? Enum.valueOf(MetricsTarget.class, objVal.isObject().get("^EnumStringValue").isString().stringValue()) : objVal.isString() != null ? Enum.valueOf(MetricsTarget.class, objVal.isString().stringValue()) : null);
        break;
        case "filter": entity.setFilter(java_lang_String.demarshall(objVal, a1));
        break;
        case "clientId": entity.setClientId(java_lang_String.demarshall(objVal, a1));
        break;
        case "nodeId": entity.setNodeId(java_lang_String.demarshall(objVal, a1));
        break;
        case "topic": entity.setTopic(java_lang_String.demarshall(objVal, a1));
        break;
        case "partition": entity.setPartition(java_lang_String.demarshall(objVal, a1));
        break;
