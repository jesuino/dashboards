...
public class Marshaller_o_j_e_c_c_PageRequest_Impl implements GeneratedMarshaller<PageRequest> {
  ...
  public String marshall(PageRequest a0, MarshallingSession a1) {
    ...
    final String prefix = ((((((((("" + "{\"") + "^EncodedType") + "\":\"") + "org.jboss.errai.common.client.PageRequest") + "\"") + ",\"") + "^ObjectID") + "\":\"") + a1.getObject(a0)) + "\"";
    if (ref) {
      return prefix + "}";
    }
    return prefix + ((((((((("" + ",\"") + "pageName") + "\":") + java_lang_String.marshall(a0.getPageName(), a1)) + ",\"") + "state") + "\":") + java_util_Map.marshall(a0.getState(), a1)) + "}");
  }
