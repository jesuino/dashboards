...
public class Marshaller_o_u_b_v_i_LockResult_Impl implements GeneratedMarshaller<LockResult> {
  ...
  public String marshall(LockResult a0, MarshallingSession a1) {
    ...
    final String prefix = ((((((((("" + "{\"") + "^EncodedType") + "\":\"") + "org.uberfire.backend.vfs.impl.LockResult") + "\"") + ",\"") + "^ObjectID") + "\":\"") + a1.getObject(a0)) + "\"";
    if (ref) {
      return prefix + "}";
    }
    return prefix + ((((((((("" + ",\"") + "success") + "\":") + java_lang_Boolean.marshall(a0.isSuccess(), a1)) + ",\"") + "lockInfo") + "\":") + org_uberfire_backend_vfs_impl_LockInfo.marshall(a0.getLockInfo(), a1)) + "}");
  }
