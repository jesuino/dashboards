...
public class Marshaller_o_u_w_m_i_ContextDefinitionImpl_Impl implements GeneratedMarshaller<ContextDefinitionImpl> {
  ...
  public String marshall(ContextDefinitionImpl a0, MarshallingSession a1) {
    ...
    final String prefix = ((((((((("" + "{\"") + "^EncodedType") + "\":\"") + "org.uberfire.workbench.model.impl.ContextDefinitionImpl") + "\"") + ",\"") + "^ObjectID") + "\":\"") + a1.getObject(a0)) + "\"";
    if (ref) {
      return prefix + "}";
    }
    return prefix + ((((("" + ",\"") + "place") + "\":") + java_lang_Object.marshall(a0.getPlace(), a1)) + "}");
  }
