...
public class Marshaller_o_u_w_e_ResourceRenamed_Impl implements GeneratedMarshaller<ResourceRenamed> {
  ...
  public String marshall(ResourceRenamed a0, MarshallingSession a1) {
    ...
    final String prefix = ((((((((("" + "{\"") + "^EncodedType") + "\":\"") + "org.uberfire.workbench.events.ResourceRenamed") + "\"") + ",\"") + "^ObjectID") + "\":\"") + a1.getObject(a0)) + "\"";
    if (ref) {
      return prefix + "}";
    }
