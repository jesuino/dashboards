...
public class Marshaller_o_u_m_i_DefaultPlaceRequest_Impl implements GeneratedMarshaller<DefaultPlaceRequest> {
  ...
  public String marshall(DefaultPlaceRequest a0, MarshallingSession a1) {
    ...
    final String prefix = ((((((((("" + "{\"") + "^EncodedType") + "\":\"") + "org.uberfire.mvp.impl.DefaultPlaceRequest") + "\"") + ",\"") + "^ObjectID") + "\":\"") + a1.getObject(a0)) + "\"";
    if (ref) {
      return prefix + "}";
    }
