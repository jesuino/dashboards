...
public class Marshaller_o_u_e_p_m_RuntimePlugin_Impl implements GeneratedMarshaller<RuntimePlugin> {
  ...
  public String marshall(RuntimePlugin a0, MarshallingSession a1) {
    ...
    final String prefix = ((((((((("" + "{\"") + "^EncodedType") + "\":\"") + "org.uberfire.ext.plugin.model.RuntimePlugin") + "\"") + ",\"") + "^ObjectID") + "\":\"") + a1.getObject(a0)) + "\"";
    if (ref) {
      return prefix + "}";
    }
    return prefix + ((((((((("" + ",\"") + "style") + "\":") + java_lang_String.marshall(a0.getStyle(), a1)) + ",\"") + "script") + "\":") + java_lang_String.marshall(a0.getScript(), a1)) + "}");
  }
