...
public class Marshaller_o_d_n_i_NavDividerImpl_Impl implements GeneratedMarshaller<NavDividerImpl> {
  private NavDividerImpl[] EMPTY_ARRAY = new NavDividerImpl[0];
  ...
  public NavDividerImpl[] getEmptyArray() {
    return EMPTY_ARRAY;
  }
  ...
  public NavDividerImpl demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(NavDividerImpl.class, objId);
    }
    NavDividerImpl entity = new NavDividerImpl();
  ...
  public String marshall(NavDividerImpl a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final String prefix = ((((((((("" + "{\"") + "^EncodedType") + "\":\"") + "org.dashbuilder.navigation.impl.NavDividerImpl") + "\"") + ",\"") + "^ObjectID") + "\":\"") + a1.getObject(a0)) + "\"";
    if (ref) {
      return prefix + "}";
    }
