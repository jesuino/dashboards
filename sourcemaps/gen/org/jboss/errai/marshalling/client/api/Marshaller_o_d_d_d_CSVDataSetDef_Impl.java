...
public class Marshaller_o_d_d_d_CSVDataSetDef_Impl implements GeneratedMarshaller<CSVDataSetDef> {
  ...
  public CSVDataSetDef demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(CSVDataSetDef.class, objId);
    }
    CSVDataSetDef entity = new CSVDataSetDef();
    ...
    for (String key : keys) {
      ...
      switch (key) {
        case "fileURL": entity.setFileURL(java_lang_String.demarshall(objVal, a1));
        break;
        case "filePath": entity.setFilePath(java_lang_String.demarshall(objVal, a1));
        break;
        case "separatorChar": entity.setSeparatorChar(java_lang_Character.demarshall(objVal, a1));
        break;
        case "quoteChar": entity.setQuoteChar(java_lang_Character.demarshall(objVal, a1));
        break;
        case "escapeChar": entity.setEscapeChar(java_lang_Character.demarshall(objVal, a1));
        break;
        case "datePattern": entity.setDatePattern(java_lang_String.demarshall(objVal, a1));
        break;
        case "numberPattern": entity.setNumberPattern(java_lang_String.demarshall(objVal, a1));
        break;
