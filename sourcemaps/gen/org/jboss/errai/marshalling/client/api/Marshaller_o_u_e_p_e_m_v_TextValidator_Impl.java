...
public class Marshaller_o_u_e_p_e_m_v_TextValidator_Impl implements GeneratedMarshaller<TextValidator> {
  ...
  public String marshall(TextValidator a0, MarshallingSession a1) {
    ...
    final String prefix = ((((((((("" + "{\"") + "^EncodedType") + "\":\"") + "org.uberfire.ext.properties.editor.model.validators.TextValidator") + "\"") + ",\"") + "^ObjectID") + "\":\"") + a1.getObject(a0)) + "\"";
    if (ref) {
      return prefix + "}";
    }
