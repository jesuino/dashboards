...
public class Marshaller_o_d_d_d_BeanDataSetDef_Impl implements GeneratedMarshaller<BeanDataSetDef> {
  ...
  public BeanDataSetDef demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(BeanDataSetDef.class, objId);
    }
    BeanDataSetDef entity = new BeanDataSetDef();
    ...
    for (String key : keys) {
      ...
      switch (key) {
        case "generatorClass": entity.setGeneratorClass(java_lang_String.demarshall(objVal, a1));
        break;
        case "paramaterMap": a1.setAssumedMapKeyType("java.lang.String");
        a1.setAssumedMapValueType("java.lang.String");
        entity.setParamaterMap(java_util_Map.demarshall(objVal, a1));
