...
public class Marshaller_j_l_StackTraceElement_Impl implements GeneratedMarshaller<StackTraceElement> {
  ...
  public String marshall(StackTraceElement a0, MarshallingSession a1) {
    ...
    final String prefix = ((((((((("" + "{\"") + "^EncodedType") + "\":\"") + "java.lang.StackTraceElement") + "\"") + ",\"") + "^ObjectID") + "\":\"") + a1.getObject(a0)) + "\"";
    if (ref) {
      return prefix + "}";
    }
    return prefix + ((((((((((((((((("" + ",\"") + "fileName") + "\":") + java_lang_String.marshall(a0.getFileName(), a1)) + ",\"") + "methodName") + "\":") + java_lang_String.marshall(a0.getMethodName(), a1)) + ",\"") + "lineNumber") + "\":") + java_lang_Integer.marshall(a0.getLineNumber(), a1)) + ",\"") + "declaringClass") + "\":") + java_lang_String.marshall(a0.getClassName(), a1)) + "}");
  }
