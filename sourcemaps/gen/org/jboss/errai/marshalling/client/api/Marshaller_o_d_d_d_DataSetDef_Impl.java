...
public class Marshaller_o_d_d_d_DataSetDef_Impl implements GeneratedMarshaller<DataSetDef> {
  ...
  public DataSetDef demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(DataSetDef.class, objId);
    }
    DataSetDef entity = new DataSetDef();
