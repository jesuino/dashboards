...
public class AppNavBar implements Header {
    ...
    public Element headerContainer;
    ...
    public void setHide(boolean hide) {
        ...
        var headerParent =
                header.getHeaderWidget()
                        ...
                        .getElement()
                        .getParentElement();
        if (headerParent.getParentElement() != null) {
            headerContainer = headerParent.getParentElement();
        }
        if (_hide) {
            headerParent.removeFromParent();
        } else if (!headerContainer.isOrHasChild(headerParent)) {
            headerContainer.appendChild(headerParent);
        }
    }
}