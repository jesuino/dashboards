 ...
 */
public class RouterScreenActivity extends AbstractWorkbenchScreenActivity {

    @Inject
    private RouterScreen realPresenter;

    @Inject
    //Constructor injection for testing
    public RouterScreenActivity(final PlaceManager placeManager) {
        super( placeManager );
    }
