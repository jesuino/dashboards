...
public class Uint8Array extends TypedArray {
  ...
  public static native <S> Uint8Array from(
      Uint8Array.FromSourceUnionType source, Uint8Array.FromMapFn mapFn, S this_);
  ...
  public static final <S> Uint8Array from(
      JsArrayLike<Double> source, Uint8Array.FromMapFn mapFn, S this_) {
    return from(Js.<Uint8Array.FromSourceUnionType>uncheckedCast(source), mapFn, this_);
  }
  ...
  @JsOverlay
  public static final <S> Uint8Array from(
      JsIterable<Double> source, Uint8Array.FromMapFn mapFn, S this_) {
    return from(Js.<Uint8Array.FromSourceUnionType>uncheckedCast(source), mapFn, this_);
  }
  ...
  @JsOverlay
  public static final <S> Uint8Array from(String source, Uint8Array.FromMapFn mapFn, S this_) {
    return from(Js.<Uint8Array.FromSourceUnionType>uncheckedCast(source), mapFn, this_);
  }
  ...
  @JsOverlay
  public static final <S> Uint8Array from(double[] source, Uint8Array.FromMapFn mapFn, S this_) {
